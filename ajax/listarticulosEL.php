...
$congelado=$row['congelado'];	if($congelado==0){$congelado="";};
$ide=$row['id']; $repo=$row['repo']; $stock=$row['stock']; if(!$repo){$repo2=0;}else{$repo2=$repo;};


$listado .="
<tr>
<td style='width:125px; font-size:10px; color:#444444;'>$codbarras</td>
<td style='width:33px; text-align:center; font-size:10px; color:#444444;'>$congelado</td>
<td style='width:35px; text-align:center; font-size:10px; color:#444444;'>$stock</td>
<script> window.top.listAEL.push($ide); </script>
</tr>
	";
$count++;
};
...
console.info(window.top.listAEL);
