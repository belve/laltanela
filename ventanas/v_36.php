...
<div style="float: left; position: relative; margin-left: 10px;   margin-top: 14px;">	
...
<div class="boton" style=" margin-left: 2px; width: 100px;"; onclick="javascript:informePV();" >Informe >> </div>
</div>
