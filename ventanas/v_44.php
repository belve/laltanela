...
<div class="boton" style=" margin-left: 2px; width: 120px;"; onclick="javascript:informeAUd(1);" >Tiendas Simple >> </div>
<div class="boton" style=" margin-left: 2px; width: 120px;"; onclick="javascript:informeAUd(2);" >Tiendas Detalle >> </div>

<div class="boton" style="margin-top:10px; margin-left: 2px; width: 120px;"; onclick="javascript:informeAUd(3);" >Almacen Simple >> </div>
<div class="boton" style=" margin-left: 2px; width: 120px;"; onclick="javascript:informeAUd(4);" >Almacen Detalle >> </div>
