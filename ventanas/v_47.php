...
function listaArticulosR(hago){
var tempR=document.getElementById('tempR').value;	
if(!tempR){
alert('Indique la temporada donde desea hacer reposiciones');	
}else{
timer(1);
...
url = "/ajax/listarticulosR.php?hago=" + hago + "&id_proveedor=" + prov
 + "&id_grupo=" + grup
 + "&id_subgrupo=" + subg
 + "&id_color=" + colo
 + "&codigo=" + codi
...
<div style=" float:left; ">
	...
	<div style="border:1px solid #888888; padding:5px;margin-top: 20px;";>
	<div style="position: relative; float:left;">
	<div>Temp:</div><input type="text" class="corto" id="tempR"> 
	</div>
	
	<div style=" float: left;    left: 15px;    position: relative;    top: 3px;    width: 73px;" onclick="listaArticulosR('');" class="boton">Listar</div>
...
<div class="cabartC">
	<div class="cabtab_artC tab_artC_codbar" style="width: 148px;">Articulo</div>

	<div class="cabtab_artC tab_artC_cong">Cant</div>
</div>
